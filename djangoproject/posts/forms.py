...
class HomeForm(forms.ModelForm):
    lect_name = forms.ModelChoiceField(label='Lecturer name', queryset=CustomUser.objects.filter(is_teacher=True)) #is it better with widget=forms.TextInput(attrs={"placeholder": "Lecturer name"})
